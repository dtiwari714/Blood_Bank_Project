<%@ Page Title="" Language="C#" MasterPageFile="~/Information_Forms.Master" AutoEventWireup="true" Inherits="Blood_Bank_Project.Donor_Information" Codebehind="Donor_Information.aspx.cs" %>
...
<%--<div class="container mt-3" style="font-weight: bolder; text-transform: none; color: #C0C0C0; text-align:center; font-family: 'Times New Roman'; font-size: large;" >
    ...
    <div class="auto-style2" style="align-content:center;margin-top:24px;margin-bottom:24px">
        ...
        <tr>
                <td colspan="2" style="text-align:center; color: #FFFFFF; font-size:30px">Donor Registration</td>
            </tr>
        <tr>
            <td><asp:Label ID="Label12" runat="server" Text="Donor Name:" class="form-control-label" ForeColor="White"></asp:Label></td>
            <td><asp:TextBox ID="TextBox7" runat="server" type="text" Class="form-control"></asp:TextBox></td>
        </tr>
        <tr>
            <td><asp:Label ID="Label2" runat="server" Text="Donor photo:" class="form-control-label" ForeColor="White"></asp:Label></td>
